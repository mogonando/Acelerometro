...
void BOARD_LedsPints(void)
{
    ...
    GPIO_PinInit(BOARD_LEDSPINTS_LED_RED_GPIO, BOARD_LEDSPINTS_LED_RED_PIN, &LED_RED_config);
    ...
    GPIO_PinInit(BOARD_LEDSPINTS_LED_GREEN_GPIO, BOARD_LEDSPINTS_LED_GREEN_PIN, &LED_GREEN_config);
    ...
    GPIO_PinInit(BOARD_LEDSPINTS_LED_BLUE_GPIO, BOARD_LEDSPINTS_LED_BLUE_PIN, &LED_BLUE_config);

    /* PORTB10 (pin 13) is configured as PTB10 */
    PORT_SetPinMux(BOARD_LEDSPINTS_LED_BLUE_PORT, BOARD_LEDSPINTS_LED_BLUE_PIN, kPORT_MuxAsGpio);

    /* PORTB6 (pin 1) is configured as PTB6 */
    PORT_SetPinMux(BOARD_LEDSPINTS_LED_RED_PORT, BOARD_LEDSPINTS_LED_RED_PIN, kPORT_MuxAsGpio);

    /* PORTB7 (pin 2) is configured as PTB7 */
    PORT_SetPinMux(BOARD_LEDSPINTS_LED_GREEN_PORT, BOARD_LEDSPINTS_LED_GREEN_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
